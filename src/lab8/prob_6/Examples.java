...
public class Examples {
	...
	Comparator<String> bifuncComp = String::compareTo;
	...
	Function<String, Integer> purseFunc = Integer::parseInt;
	...
	BiFunction<Employee, Employee, Integer> bifEmployee = emp::compare;

	void evaluator() {
		System.out.println(e.apply(new Employee("Test")));
	}
