...
public class Employee {
	...
	public static void main(String[] args) {
		...
		System.out.println(getSortedEmployee(list));
	}
	
	
	public static List<Employee> getSortedEmployee(List<Employee> empLst){
		return empLst.stream().sorted(Comparator.comparing(Employee::getName).thenComparing(Employee::getSalary, Comparator.reverseOrder())).collect(Collectors.toList());
	}
}
